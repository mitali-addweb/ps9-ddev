...
{else}
	{if !isset($is_ps_old_version)}
		<div class="alert alert-info">
			...
			<br/>
			{l s='How do I download custom design template images? Do the following:' mod='tshirtecommerce'}<br/>
			- {l s='Click to View on Designer Tool' mod='tshirtecommerce'}<br/>
			- {l s='Right click your mouse > Save image as...' mod='tshirtecommerce'}
		</div>
	{/if}
	...
	<script type="text/javascript" src="{$url}tshirtecommerce/prestashop/js/app.js"></script>
	<script type="text/javascript" src="{$url}tshirtecommerce/prestashop/js/prestashop.js"></script>
	{if isset($is_ps_old_version)}
	<script type="text/javascript">
